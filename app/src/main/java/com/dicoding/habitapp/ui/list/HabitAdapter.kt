...
class HabitAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): HabitViewHolder {
        ...
        val view = layoutInflater.inflate(R.layout.habit_item, parent, false)
    ...
    inner class HabitViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(habit: Habit) {
            ...
            when (habit.priorityLevel) {
                itemView.context.resources.getStringArray(R.array.priority_level)[0] -> {
                    ivPriority.setImageResource(R.drawable.ic_priority_high)
                }
                itemView.context.resources.getStringArray(R.array.priority_level)[1] -> {
